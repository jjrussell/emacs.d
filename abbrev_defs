...
(define-abbrev-table 'global-abbrev-table
  '(
    ("hte" "the" nil 4)
    ("rdb" "require 'debugger' ; debugger" nil 2)
    ("teh" "the" nil 5)
   ))
...
(define-abbrev-table 'ioccur-mode-abbrev-table '())
...
(define-abbrev-table 'ruby-mode-abbrev-table
  '(
    ("rdb" "begin require 'pry-debugger' ; rescue LoadError ; require 'pry-byebug';  end ; binding.pry" nil 41)
    ("rdbr" "require 'pry-remote' ; require 'pry-debugger' ; binding.remote_pry" nil 12)
   ))
