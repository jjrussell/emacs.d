...
(custom-set-variables
 ...
 '(package-selected-packages
   '(ac-etags ace-jump-mode ack add-node-modules-path ag aggressive-indent alchemist all-the-icons
              all-the-icons-completion all-the-icons-dired all-the-icons-ibuffer auto-indent-mode bm
              browse-kill-ring buffer-move bundler centered-window coffee-mode
              ...
              undo-tree uniquify use-package vertica wgrep window-numbering writeroom-mode xml-rpc
              xref-js2 yafolding yaml-mode yasnippet-snippets))
 '(ps-line-number t)
